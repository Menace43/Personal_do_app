...
class App(customtkinter.CTk):
    ...
    def savebtn_clicked(self,choice):
        ...
        self.scrollable_checkbox_frame.add_item_frame(text_entered,additional_details=detail_text_entered)
...
class CalendarFrame(customtkinter.CTkToplevel):
    ...
    def create_win_elements(self):
        ...
        self.done_btn=customtkinter.CTkButton(self.clear_frame,text="Done",bg_color="transparent")
